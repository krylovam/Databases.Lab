...
# Form implementation generated from reading ui file 'searchActorMenu.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.byShowIdBtn = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.byShowIdBtn.setMinimumSize(QtCore.QSize(0, 50))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.byShowIdBtn.setFont(font)
        self.byShowIdBtn.setObjectName("byShowIdBtn")
        self.verticalLayout.addWidget(self.byShowIdBtn)
        self.byCharacterNameBtn = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.byCharacterNameBtn.setMinimumSize(QtCore.QSize(50, 50))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.byCharacterNameBtn.setFont(font)
        self.byCharacterNameBtn.setObjectName("byCharacterNameBtn")
        self.verticalLayout.addWidget(self.byCharacterNameBtn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.byNameBtn.setText(_translate("MainWindow", "Найти по имени"))
        self.byShowIdBtn.setText(_translate("MainWindow", "Найти по id шоу"))
        self.byCharacterNameBtn.setText(_translate("MainWindow", "Найти по имени персонажа"))
